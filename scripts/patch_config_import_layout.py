...
DOWNLOAD_PATCHES: list[tuple[str, str, str]] = [
    (
        ...
        "computed(()=>{try{return T()}catch(_){console.log(_)}});const x=()=>{if(n.value==null",
        (
            "const mikazukiUsesBackendExport=pt=>pt===\"sd3-lora\"||pt===\"anima-lora\"||pt===\"anima-finetune\","
...
PREVIEW_OVERLAY_PATCHES: list[tuple[str, str, str]] = [
    (
        ...
        (
            ...
            "watch([()=>a.value,()=>n.value],()=>{if(n.value!=null)scheduleBackendPreview()},{deep:!0}),"
